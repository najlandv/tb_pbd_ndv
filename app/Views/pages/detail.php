...
<div class="container">
    ...
    <input type="number" placeholder="1" min="1" name="jumlahBarang" style="padding-left: 10px; font-size: 13px; border: 1px solid #222; width: 50px; border-radius: 50px; height: 25px; outline: none;">
</div>
        ...
        <!-- Additional Section for Voucher Code and Referral Code -->
        <!-- <div class="col sub-con-alamat text-end">
            <div class="mb-3">
                <label for="voucherCode" class="form-label" style="font-size: 15px; font-weight: 600; color: rgb(91, 91, 91);">Voucher Code</label>
                <input type="text" class="form-control" id="voucherCode" name="voucherCode" style="font-size: 13px;">
            </div>
            <div>
                <label for="referralCode" class="form-label" style="font-size: 15px; font-weight: 600; color: rgb(91, 91, 91);">Referral Code</label>
                <input type="text" class="form-control" id="referralCode" name="referralCode" style="font-size: 13px;">
            </div>
        </div>
    </div>
</div> -->
